...
const AnimatedCheckBox = ({ children, onCheck }) => {
    return (
        <>
            <svg
                viewBox="0 0 0 0"
            ...
            >
                <defs>
                    ...
                    <stop offset="0%" stopColor="" />
                        <stop offset="100%" stopColor="#8719E0" />
                    </linearGradient>

                    <linearGradient id="lineGradient">
                        <stop offset="0%" stopColor="#8719E0" />
                        <stop offset="100%" stopColor="#8719E0" />
                    </linearGradient>
            ...
            <div className="todo-list">
                <label className="todo">
                    <input className="todo__state" type="checkbox" onChange={onCheck} />
                    ...
                    >
                        ...
                        <use
                            xlinkHref="#todo__circle"
                            className="todo__circle"
                        />
                    </svg>

                    <div className="todo__text">{children}</div>
                </label>
            </div>
        </>
    )
